...
genomics_project = {
    ...
    "attributes": [
        {"key": "description", "value": "Large-scale genomic sequencing and analysis of human populations"},
...
cancer_project = {
    ...
    "attributes": [
        {"key": "description", "value": "Identification of novel biomarkers for early pancreatic cancer detection"},
...
agriculture_project = {
    ...
    "attributes": [
        {"key": "description", "value": "Genetic engineering of wheat varieties for improved drought tolerance"},
...
microbiome_project = {
    ...
    "attributes": [
        {"key": "description", "value": "Investigating the relationship between gut microbiome composition and metabolic disorders"},
...
evolution_project = {
    ...
    "attributes": [
        {"key": "description", "value": "Comparative genomics study of primate species to understand evolutionary adaptations"},
...
SEARCH_TERMS = {
    ...
    "sequencing": ["Human Genome Sequencing Initiative", "Drought-Resistant Wheat Development", "Gut Microbiome and Metabolic Health", "Primate Evolution and Adaptation"],
    "Dr": ["Human Genome Sequencing Initiative", "Pancreatic Cancer Biomarker Discovery", "Drought-Resistant Wheat Development", "Gut Microbiome and Metabolic Health", "Primate Evolution and Adaptation"],
    "High": ["Human Genome Sequencing Initiative", "Gut Microbiome and Metabolic Health"],
