...
def downgrade() -> None:
    ...
    op.drop_table('fileqcrecord', if_exists=True)
    op.drop_table('workflowrunattribute', if_exists=True)
    op.drop_table('samplesequencingrun', if_exists=True)
    op.drop_table('sampleattribute', if_exists=True)
    op.drop_table('qcrecord', if_exists=True)
    op.drop_table('fileworkflowrun', if_exists=True)
    op.drop_table('filesample', if_exists=True)
    op.drop_table('workflowrun', if_exists=True)
    op.drop_table('workflowregistration', if_exists=True)
    op.drop_table('workflowattribute', if_exists=True)
    op.drop_table('sample', if_exists=True)
    op.drop_table('refresh_tokens', if_exists=True)
    op.drop_table('projectattribute', if_exists=True)
    op.drop_table('pipelineworkflow', if_exists=True)
    op.drop_table('pipelineattribute', if_exists=True)
    op.drop_table('password_reset_tokens', if_exists=True)
    op.drop_table('oauth_providers', if_exists=True)
    op.drop_table('filetag', if_exists=True)
    op.drop_table('filesequencingrun', if_exists=True)
    op.drop_table('fileproject', if_exists=True)
    op.drop_table('filepipeline', if_exists=True)
    op.drop_table('filehash', if_exists=True)
    op.drop_table('email_verification_tokens', if_exists=True)
    op.drop_table('api_keys', if_exists=True)
    op.drop_table('workflow', if_exists=True)
    op.drop_table('vendor', if_exists=True)
    op.drop_table('users', if_exists=True)
    op.drop_table('setting', if_exists=True)
    op.drop_table('sequencingrun', if_exists=True)
    op.drop_table('project', if_exists=True)
    op.drop_table('platform', if_exists=True)
    op.drop_table('pipeline', if_exists=True)
    op.drop_table('file', if_exists=True)
    op.drop_table('batchjob', if_exists=True)
    # ### end Alembic commands ###
