...
def list_files(
    uri: str = Query(..., description="URI to list (e.g., s3://bucket/folder/ or /local/path)"),
    storage_root: str = Query(..., description="Root directory that acts as the boundary for navigation. "
